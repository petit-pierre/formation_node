"use strict";
// 😱😱😱 j'ai juste modifié l'extension .js en .ts pour passer ce script en TypeScript
// et regardez toutes ces erreurs !!!
Object.defineProperty(exports, "__esModule", { value: true });
// Si j'importe ce script dans ma page html rien ne fonctionne
// 😮‍💨 Pas de panique, tout va bien.
// En TypeScript nous devrons specifier le type (number, string ...) de nos variables
// Ca peut sembler fastidieux mais en verité c'est beaucoup plus safe et ca evite de nombreuses erreurs
// De plus les navigateurs ne savent pas interpreter le .ts, il nous faudra donc compiler notre code.
// pour ce faire nous allons ajouter un node module via la commande:
// npm i -g typescript
// -g car ce module nous sera util a tout nos projet typescript et nous n'aurons pas besoin de l'envoyer en prod
// ensuite il faudra dans le terminal faire le commande :
// npx tsc index.ts
// pour compiler notre fichier .ts en .js lisible par les navigateurs
...
function validateConnexion() {
    if (document.querySelector(".login").value.length > 2 &&
